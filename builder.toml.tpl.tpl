buildpacks = [
  { id = "io.projectriff.command",       uri = "https://storage.googleapis.com/projectriff/command-function-buildpack/io.projectriff.command-{{ curl -s https://storage.googleapis.com/projectriff/command-function-buildpack/versions/releases/master }}.tgz" },
  { id = "io.projectriff.java",          uri = "https://storage.googleapis.com/projectriff/java-function-buildpack/io.projectriff.java-{{ curl -s https://storage.googleapis.com/projectriff/java-function-buildpack/versions/releases/v0.2.x }}.tgz" },
  { id = "io.projectriff.node",          uri = "https://storage.googleapis.com/projectriff/node-function-buildpack/io.projectriff.node-{{ curl -s https://storage.googleapis.com/projectriff/node-function-buildpack/versions/releases/v0.2.x }}.tgz" },
