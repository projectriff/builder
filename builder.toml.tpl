...
buildpacks = [
  ...
  { id = "io.projectriff.node",          uri = "https://storage.googleapis.com/projectriff/node-function-buildpack/io.projectriff.node-0.3.0-BUILD-SNAPSHOT-20200324133839-82d667c353f35709.tgz" },
  ...
  { id = "org.cloudfoundry.yarn-install",        uri = "https://github.com/cloudfoundry/yarn-install-cnb/releases/download/v0.1.14/yarn-install-cnb-0.1.14.tgz" },
